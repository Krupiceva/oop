/*
 * 3. laboratorijska vjezba iz Objektno orijentiranog programiranja
 */
...
public class SimpleHashtable implements Iterable {
    ...
    /**
     * This is factory method for iterators
     *
     * @return iterator
     */
    @Override
    ...
    private class CustomIterator implements Iterator {
        ...
        /**
         * Checks if there is more element
         *
         * @return true if it is, false if not
         */
        @Override
        ...
        /**
         * This method search for next element
         *
         * @return next element if exist
         */
        @Override
        public TableEntry next() {
            if (!hasNext()) {
                ...
                TableEntry returnValue = current;
                index++;
